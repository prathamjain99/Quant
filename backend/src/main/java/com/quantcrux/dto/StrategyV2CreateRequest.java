...
public class StrategyV2CreateRequest {
    ...
    // Constructors
    public StrategyV2CreateRequest() {}

    public StrategyV2CreateRequest(String name, String description, Map<String, Object> codeJson, List<String> tags) {
        this.name = name;
